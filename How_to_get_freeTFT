# How to get FreeTFT, usable for exploring our grid. 
...
First create a wallet. A web wallet, able to do trading with other cryptocurrencies, is available on https://interstellar.exchange/ . Alternatively there are a number of wallets available on the market that can be used. 
